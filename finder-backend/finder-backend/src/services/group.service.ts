...
export class GroupService {
    ...
    static async createGroup(groupData: Groups, userEmails: string[]): Promise<Groups> {
        try {
    ...
    static async deleteGroup(groupId: string): Promise<void> {
        try {
            ...
            // Remove todas as relações entre o grupo e os usuários
            group.users = [];
            await group.save();

            // Exclui o grupo após remover as relações
